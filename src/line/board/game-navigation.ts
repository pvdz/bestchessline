 ...
 */
export function addMove(move: ChessMove): void {
 ...
 */
export function importGame(notation: string): void {
 ...
 */
export function previousMove(): void {
  const appState = getAppState();
