...
class ChessAnalysisApp {
  ...
  private initializeEventListeners(): void {
    ...
    if (prevMoveBtn) prevMoveBtn.addEventListener('click', () => this.previousMove());
  ...
  private selectCorrectMove(validMoves: string[], toSquare: string, piece: string, board: string[][]): string {
  ...
  private selectCorrectBishop(validMoves: string[], toSquare: string, board: string[][]): string {
  ...
  private selectCorrectKnight(validMoves: string[], toSquare: string, board: string[][]): string {
  ...
  private selectCorrectRook(validMoves: string[], toSquare: string, board: string[][]): string {
  ...
  private selectCorrectPawn(validMoves: string[], toSquare: string, board: string[][]): string {
  ...
  private canPieceMoveTo(fromSquare: string, toSquare: string, piece: string, board: string[][]): boolean {
  ...
  private canPawnMoveTo(fromSquare: string, toSquare: string, board: string[][]): boolean {
    const fromRank = 8 - parseInt(fromSquare[1]);
    const fromFile = fromSquare.charCodeAt(0) - 'a'.charCodeAt(0);
    const toRank = 8 - parseInt(toSquare[1]);
    const toFile = toSquare.charCodeAt(0) - 'a'.charCodeAt(0);
  ...
  private canRookMoveTo(fromSquare: string, toSquare: string, board: string[][]): boolean {
    const fromRank = 8 - parseInt(fromSquare[1]);
    const fromFile = fromSquare.charCodeAt(0) - 'a'.charCodeAt(0);
    const toRank = 8 - parseInt(toSquare[1]);
    const toFile = toSquare.charCodeAt(0) - 'a'.charCodeAt(0);
  ...
  private canKnightMoveTo(fromSquare: string, toSquare: string, board: string[][]): boolean {
    const fromRank = 8 - parseInt(fromSquare[1]);
    const fromFile = fromSquare.charCodeAt(0) - 'a'.charCodeAt(0);
    const toRank = 8 - parseInt(toSquare[1]);
    const toFile = toSquare.charCodeAt(0) - 'a'.charCodeAt(0);
  ...
  private canBishopMoveTo(fromSquare: string, toSquare: string, board: string[][]): boolean {
    const fromRank = 8 - parseInt(fromSquare[1]);
    const fromFile = fromSquare.charCodeAt(0) - 'a'.charCodeAt(0);
    const toRank = 8 - parseInt(toSquare[1]);
    const toFile = toSquare.charCodeAt(0) - 'a'.charCodeAt(0);
  ...
  private canQueenMoveTo(fromSquare: string, toSquare: string, board: string[][]): boolean {
  ...
  private canKingMoveTo(fromSquare: string, toSquare: string, board: string[][]): boolean {
    const fromRank = 8 - parseInt(fromSquare[1]);
    const fromFile = fromSquare.charCodeAt(0) - 'a'.charCodeAt(0);
    const toRank = 8 - parseInt(toSquare[1]);
    const toFile = toSquare.charCodeAt(0) - 'a'.charCodeAt(0);
  ...
  private findFromSquareFallback(piece: string, toSquare: string): string | null {
    // Fallback to simple heuristics if no legal move found
    if (piece === 'K') {
