 ...
 */
export const startLineFisherAnalysisFromManager = async (): Promise<void> => {
  try {
 ...
 */
export const stopLineFisherAnalysisFromManager = async (): Promise<void> => {
 ...
 */
export const continueLineFisherAnalysisFromManager =
  async (): Promise<void> => {
 ...
 */
export const copyLineFisherStateToClipboardFromManager =
  async (): Promise<void> => {
 ...
 */
export const exportLineFisherStateFromManager = async (): Promise<void> => {
 ...
 */
export const importLineFisherStateFromManager = async (): Promise<void> => {
 ...
 * Show current state information in the UI
 */
export const updateLineFisherStateInfo = async (
 ...
 */
export const handleLineFisherStateFileInput = async (
  event: Event,
): Promise<void> => {
 ...
 */
export const recoverLineFisherFromCrash = async (): Promise<void> => {
 ...
 */
export const handleLineFisherError = (error: Error, context: string): void => {
  ...
  const userMessage =
    errorMessages[category as keyof typeof errorMessages] ||
 ...
 */
export const recoverFromLineFisherError = async (): Promise<void> => {
 ...
 */
export const validateLineFisherState = (
  state: LineFisherState,
