 ...
 */
export function updateResults(result: AnalysisResult): void {
 ...
 */
export function makeAnalysisMove(move: ChessMove): void {
 ...
 */
export function addPVClickListeners(): void {
 ...
 */
export function handleMakeEngineMove(move: AnalysisMove): void {
