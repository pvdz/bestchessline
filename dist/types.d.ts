...
export declare function isPieceTypeNotation(
  value: string,
): value is PieceTypeNotation;
...
export declare function isWhitePieceNotation(
  value: string,
): value is WhitePieceNotation;
export declare function isBlackPieceNotation(
  value: string,
): value is BlackPieceNotation;
export declare function createPieceTypeNotation(
  value: string,
): PieceTypeNotation;
...
export declare function createWhitePieceNotation(
  value: string,
): WhitePieceNotation;
export declare function createBlackPieceNotation(
  value: string,
): BlackPieceNotation;
...
export declare function getPieceNotation(
  type: PieceTypeNotation,
  color: ColorNotation,
): PieceNotation;
export declare function getPieceTypeFromNotation(
  piece: PieceNotation,
): PieceTypeNotation;
export declare function getColorFromNotation(
  piece: PieceNotation,
): ColorNotation;
/**
 * Version tracking for state format compatibility
 */
export declare const TREE_DIGGER_STATE_VERSION = "1.0.0";
/**
