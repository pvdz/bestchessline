...
import { updateTreeDiggerStatus, updateAnalysisStatus, updateLineFisherStatus, } from "./utils/status-management.js";
...
import { startTreeDiggerAnalysisFromManager, stopTreeDiggerAnalysisFromManager, clearTreeDiggerAnalysisFromManager, continueTreeDiggerAnalysisFromManager, recoverFromCrash, updateTreeDiggerButtonStates, exportTreeDiggerStateFromManager, copyTreeDiggerStateToClipboardFromManager, importTreeDiggerStateFromClipboardFromManager, handleStateFileInput, updateTreeDiggerStateInfo, } from "./utils/tree-digger-manager.js";
import { startLineFisherAnalysisFromManager, stopLineFisherAnalysisFromManager, resetLineFisherAnalysisFromManager, continueLineFisherAnalysisFromManager, copyLineFisherStateToClipboardFromManager, exportLineFisherStateFromManager, importLineFisherStateFromClipboardFromManager, handleLineFisherStateFileInput, } from "./utils/line-fisher-manager.js";
...
const initializeEventListeners = () => {
    ...
    const stateFileInput = document.getElementById("tree-digger-state-file");
    if (exportStateBtn) {
    ...
    if (stopLineFisherBtn) {
        stopLineFisherBtn.addEventListener("click", () => {
            console.log("USER PRESSED STOP BUTTON - Line Fisher analysis manually stopped");
            stopLineFisherAnalysisFromManager();
        });
    }
    if (resetLineFisherBtn) {
        resetLineFisherBtn.addEventListener("click", () => resetLineFisherAnalysisFromManager());
    }
    ...
    const exportLineFisherStateBtn = document.getElementById("export-line-fisher-state");
    const copyLineFisherStateBtn = document.getElementById("copy-line-fisher-state");
    const importLineFisherStateBtn = document.getElementById("import-line-fisher-state");
    const pasteLineFisherStateBtn = document.getElementById("paste-line-fisher-state");
    const lineFisherStateFileInput = document.getElementById("line-fisher-state-file");
    ...
    if (lineFisherStateFileInput) {
        lineFisherStateFileInput.addEventListener("change", handleLineFisherStateFileInput);
    }
    // Line Fisher thread control
    const lineFisherThreadsInput = document.getElementById("line-fisher-threads");
    const lineFisherThreadsValue = document.getElementById("line-fisher-threads-value");
    ...
    const lineFisherDepthInput = document.getElementById("line-fisher-depth");
    const lineFisherDepthValue = document.getElementById("line-fisher-depth-value");
    ...
    const lineFisherDefaultResponderInput = document.getElementById("line-fisher-default-responder-count");
    const lineFisherDefaultResponderValue = document.getElementById("line-fisher-default-responder-count-value");
    ...
    window.addEventListener("stockfish-pv-line", ((_event) => {
    ...
    window.addEventListener("stockfish-crash", (() => {
        ...
        updateTreeDiggerStatus("Stockfish crashed - click 'Recover from Crash' to restart");
        updateAnalysisStatus("Stockfish crashed - click 'Recover from Crash' to restart");
        updateLineFisherStatus("Stockfish crashed - click 'Recover from Crash' to restart");
