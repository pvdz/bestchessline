...
window.addEventListener("move-parse-warning", (event) => {
    ...
    if (detail && detail.message) {
        ...
        if (!found) {
            ...
            const moveInputs = document.querySelectorAll('input[id^="tree-digger-white-move"], input[id^="tree-digger-black-move"]');
