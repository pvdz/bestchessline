...
function updateAttemptedMovesDisplay(movesHistoryEl) {
    ...
    let attemptedSection = movesHistoryEl.parentElement?.querySelector(".practice-attempted-moves");
    if (!attemptedSection) {
    ...
    const attemptedList = attemptedSection.querySelector(".practice-attempted-list");
    if (attemptedList) {
...
export function clearMoveHistory(movesHistoryEl) {
    ...
    const attemptedSection = movesHistoryEl.parentElement?.querySelector(".practice-attempted-moves");
    if (attemptedSection) {
