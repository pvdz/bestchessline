...
export function parseFEN(fen) {
    ...
    if (parts[1] !== "w" && parts[1] !== "b")
        console.warn("Warning: parseFEN() received a FEN where the current turn character was not as expected", parts, [fen]);
    const turn = parts[1];
...
export function getResponderMovesCount() {
    const responderMovesInput = document.getElementById("tree-digger-responder-moves");
 ...
 */
export function compareAnalysisMoves(a, b) {
