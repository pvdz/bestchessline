 ...
 */
export declare const updateLineFisherState: (newState: Partial<LineFisherState>) => void;
/**
...
export declare const updateLineFisherConfig: (updates: Partial<LineFisherConfig>) => void;
