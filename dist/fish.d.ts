import { StockfishOptions, PlayerColor } from "./types.js";
/**
...
export interface FishConfig {
  ...
  initiatorPredefinedMoves: string[];
  responderCountOverrides: number[];
 ...
 */
export declare function fish(config: FishConfig): Promise<FishLine[]>;
/**
