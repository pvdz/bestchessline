...
import { getPaginatedTreeNodes, renderPaginationControls, renderLargeTreeProgress, handlePaginationClick, DEFAULT_PAGINATION_CONFIG, } from "./tree-digger-pagination.js";
/**
...
export function updateTreeDiggerResults() {
    ...
    const paginationState = getPaginatedTreeNodes(analysis, currentPaginationConfig);
    if (paginationState.isLargeTree) {
        ...
        if (paginationState.totalPages > 1) {
            const paginationHTML = renderPaginationControls(paginationState, (page) => {
                currentPaginationConfig.currentPage = page;
                updateTreeDiggerResults();
            });
            // Find or create pagination section
            let paginationSection = resultsElement.querySelector(".tree-digger-pagination-section");
