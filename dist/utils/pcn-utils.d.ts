 ...
 */
export declare function convertSANLineToPCN(
  sanMoves: string[],
  startingFEN: string,
): string;
/**
 ...
 */
export declare function convertPCNToSAN(
  pcnMove: string,
  _fen: string,
): string | null;
/**
 ...
 * @returns SAN line
 */
export declare function convertPCNLineToSAN(
  pcnLine: string,
  startingFEN: string,
): string;
/**
 ...
 */
export declare function computeSanGameFromPCN(
  pcns: string[],
  rootFEN: string,
): string;
