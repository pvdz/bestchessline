 ...
 */
export declare function parseLongMove(moveStr: string, fen: string): ChessMove | null;
/**
 ...
 */
export declare function parseMoveFromNotation(moveText: string, isWhiteTurn?: boolean): ChessMove | null;
/**
 ...
 */
export declare function canKnightMoveTo(fromSquare: string, toSquare: string, _board: string[][]): boolean;
/**
 ...
 */
export declare function canKingMoveTo(fromSquare: string, toSquare: string, _board: string[][]): boolean;
/**
 * Select the correct move from multiple candidates using disambiguation
 */
export declare function selectCorrectMove(candidates: string[], _toSquare: string, _piece: PieceNotation, _board: string[][], disambiguation: string): string;
