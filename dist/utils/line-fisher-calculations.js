 ...
 */
export const calculateTotalNodes = (config) => {
 ...
 */
export const calculateResponderNodes = (config) => {
 ...
 */
export const calculateTotalLines = (config) => {
  const maxDepth = config.maxDepth;
  const responderCounts = config.responderMoveCounts;
  const defaultResponderCount = config.defaultResponderCount;
  let prod = 1;
...
//# sourceMappingURL=line-fisher-calculations.js.map
