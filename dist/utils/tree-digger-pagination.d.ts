 ...
 */
export declare const calculateTreeStatistics: (analysis: TreeDiggerAnalysis) => {
    totalNodes: number;
    totalLeafs: number;
    maxDepth: number;
    averageDepth: number;
 ...
 */
export declare const getPaginatedTreeNodes: (analysis: TreeDiggerAnalysis, config?: TreePaginationConfig) => TreePaginationState;
/**
 * Render pagination controls
 */
export declare const renderPaginationControls: (paginationState: TreePaginationState, _onPageChange: (page: number) => void) => string;
/**
 * Render progress summary for large trees
 */
export declare const renderLargeTreeProgress: (analysis: TreeDiggerAnalysis) => string;
/**
 * Handle pagination button clicks
 */
export declare const handlePaginationClick: (event: Event, onPageChange: (page: number) => void) => void;
