import { getCurrentAnalysis, isAnalyzing, getProgress, } from "../tree-digger.js";
...
const getMoveNotationFromFen = (fen, analysis) => {
    try {
        // Find the node that corresponds to this FEN
        const findNodeByFen = (nodes, targetFen) => {
 ...
 */
const getCompleteMoveSequence = (node) => {
    const moves = [];
 ...
 */
export const clearTreeNodeDOMMap = () => {
