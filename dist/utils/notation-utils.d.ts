import { ChessMove, NotationFormat, PieceFormat, PieceTypeNotation, ColorNotation } from "../line/types.js";
/**
 ...
 */
export declare function sanToLongNotation(sanMove: string, fen: string): string | null;
/**
 ...
 */
export declare function convertLineToLongNotation(sanLine: string, startingFEN: string): string;
/**
 ...
 */
export declare function convertSANLineToLongNotation(sanMoves: string[], startingFEN: string): string;
/**
