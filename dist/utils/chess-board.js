import { getPieceTypeFromNotation, getColorFromNotation, createPieceNotation, PLAYER_COLORS, } from "../line/types.js";
import { formatScoreWithMateIn } from "./formatting-utils.js";
import { getPieceSymbol } from "./notation-utils.js";
import { parseFEN, toFEN, squareToCoords, coordsToSquare, } from "./fen-utils.js";
import { PIECE_TYPES } from "./move-validator.js";
import { hideMoveArrow, positionArrow, getArrowElements, } from "../line/board/arrow-utils.js";
...
const updateDropTarget = (clientX, clientY) => {
    ...
    if (dragState.currentDropTarget) {
        const prevSquare = querySelectorOrThrow(document, `[data-square="${dragState.currentDropTarget}"]`);
        if (prevSquare) {
    ...
    if (square && square !== dragState.currentDropTarget) {
        const squareElement = querySelectorOrThrow(document, `[data-square="${square}"]`);
        if (squareElement) {
