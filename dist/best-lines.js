...
const processWhiteMoveInTree = async (fen, analysis, parentNode, depth) => {
    ...
    console.log(`Processing white move at depth ${depth}, current game move: ${currentGameMoveNumber}, tree move: ${moveNumber}`);
...
const processBlackMovesInTree = async (fen, analysis, parentNode, depth) => {
    ...
    console.log(`Processing black moves at depth ${depth}, current game move: ${currentGameMoveNumber}, tree move: ${moveNumber}`);
