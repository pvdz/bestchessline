 ...
 */
declare const analyzePosition: (fen: string, options?: StockfishOptions, onUpdate?: (result: AnalysisResult) => void) => Promise<AnalysisResult>;
...
export { initializeStockfish, getStockfishState, updateStockfishState, analyzePosition, stopAnalysis, isAnalyzingPosition, getCurrentAnalysis, destroy, isFallbackMode, };
