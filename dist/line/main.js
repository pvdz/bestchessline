...
import { startAnalysis, stopAnalysis, addPVClickListeners, handleMakeEngineMove, } from "./best/analysis-manager.js";
...
import { fish, exportFishStateToClipboard, copyFishStateToClipboard, importFishStateFromClipboard, continueFishAnalysis, stopFishAnalysis, resetFishAnalysis, } from "./fish/fish.js";
...
const initializeEventListeners = () => {
    ...
    getElementByIdOrThrow("load-mate-in-1-black").addEventListener("click", () => {
        loadFENPosition("r4rbk/2p3R1/5p1Q/pp6/8/3P4/5RPP/6K1 b - - 2 4");
    });
    getElementByIdOrThrow("load-mate-in-1-white").addEventListener("click", () => {
    ...
    const exportLineFisherStateBtn = getElementByIdOrThrow("export-line-fisher-state");
    const copyLineFisherStateBtn = getElementByIdOrThrow("copy-line-fisher-state");
    const importLineFisherStateBtn = getElementByIdOrThrow("import-line-fisher-state");
    ...
    const lineFisherThreadsValue = getElementByIdOrThrow("line-fisher-threads-value");
    ...
    const lineFisherDefaultResponderInput = getElementByIdOrThrow("line-fisher-default-responder-count");
    const lineFisherDefaultResponderValue = getElementByIdOrThrow("line-fisher-default-responder-count-value");
    // Initialize with default value
 ...
 */
async function runFish2Analysis() {
    try {
        ...
        showToast(`Fish2 error: ${error instanceof Error ? error.message : String(error)}`, "#dc3545", 5000);
    }
}
