...
const initializeEventListeners = () => {
    ...
    const lineFisherDefaultResponderInput = getElementByIdOrThrow("fish-default-responder-count");
    const lineFisherDefaultResponderValue = getElementByIdOrThrow("fish-default-responder-count-value");
    // Initialize with default value
    ...
    const lineFisherTargetDepthValue = getElementByIdOrThrow("fish-target-depth-value");
    // Initialize with default value
 ...
 */
async function runFishAnalysis() {
    try {
        ...
        showToast(`Fish2 complete: ${state.done.length} lines found`, "#28a745", 5000);
