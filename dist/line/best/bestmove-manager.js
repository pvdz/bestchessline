...
import { updateResultsPanel, formatPVWithEffects, } from "./bestmove-pv-utils.js";
...
import { updateFENInput, updateControlsFromPosition, resetPositionEvaluation, } from "../board/position-controls.js";
 ...
 */
export async function startBestmove() {
 ...
 */
export function updateBestmoveResults(result) {
 ...
 */
export function actuallyUpdateBestmovePanel(moves) {
 ...
 */
export function makeBestmove(move) {
 ...
 */
export function addBestmovePVClickListeners() {
 ...
 */
export function handleMakeBestmove(move) {
...
//# sourceMappingURL=bestmove-manager.js.map