...
import { getInputElement, getElementByIdOrThrow, } from "../../utils/dom-helpers.js";
...
export const updateLineFisherSliderValues = () => {
    ...
    const defaultResponderInput = getInputElement("line-fisher-default-responder-count");
    const defaultResponderValue = getElementByIdOrThrow("line-fisher-default-responder-count-value");
...
export const showLineFisherErrorExplanation = (error) => {
    ...
    const explanationElement = getElementByIdOrThrow("line-fisher-error-explanation");
